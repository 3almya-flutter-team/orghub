...
class OrdersOnMyAds extends StatefulWidget {
  @override
  _OrdersOnMyAdsState createState() => _OrdersOnMyAdsState();
}

class _OrdersOnMyAdsState extends State<OrdersOnMyAds>
    with TickerProviderStateMixin {
  TabController _tabController;

  GetOrdersOnMyAdsBloc getOrdersOnMyAdsBloc =
      kiwi.KiwiContainer().resolve<GetOrdersOnMyAdsBloc>();
  GetOrdersOnMySellingOrdersBloc getOrdersOnMySellingOrdersBloc =
      kiwi.KiwiContainer().resolve<GetOrdersOnMySellingOrdersBloc>();
  @override
  void initState() {
    _tabController = new TabController(vsync: this, length: 2);
    getOrdersOnMyAdsBloc.add(GetOrdersOnMyAdsEventsStart());
    super.initState();
  }
  ...
  void dispose() {
    ...
    getOrdersOnMyAdsBloc.close();
    getOrdersOnMySellingOrdersBloc.close();
    super.dispose();
  }
                ...
                onTap: (index) {
                  setState(() {
                    if (index == 0) {
                      ...
                      getOrdersOnMySellingOrdersBloc
                          .add(GetOrdersOnMySellingOrdersEventsStart());
                    }
                  });
                },
          ...
          children: <Widget>[
            Expanded(
              child: TabBarView(
                ...
                children: <Widget>[
                  BlocBuilder(
                      bloc: getOrdersOnMyAdsBloc,
                      builder: (context, state) {
                        if (state is GetOrdersOnMyAdsStatesStart) {
                          return Padding(
                        ...
                        } else if (state is GetOrdersOnMyAdsStatesSuccess) {
                                  ...
                                  itemBuilder: (context, index) {
                                    return InkWell(
                                      onTap: () {
                                        ...
                                        .then((value) {
                                          getOrdersOnMyAdsBloc.add(
                                              GetOrdersOnMyAdsEventsStart());
                                        });
                                      },
                                      child: _card(
                        ...
                        } else if (state is GetOrdersOnMyAdsStatesFailed) {
                          if (state.errType == 0) {
                  ...
                  //------------
                  BlocBuilder(
                      bloc: getOrdersOnMySellingOrdersBloc,
                      builder: (context, state) {
                        if (state is GetOrdersOnMySellingOrdersStatesStart) {
                          return Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: SpinKitThreeBounce(
                              color: AppTheme.primaryColor,
                            ...
                            is GetOrdersOnMySellingOrdersStatesSuccess) {
                          return state.mySellingOrders.isEmpty
                                  ...
                                  itemBuilder: (context, index) {
                                    return InkWell(
                                      onTap: () {
                                        ...
                                        .then((_) {
                                          getOrdersOnMySellingOrdersBloc.add(
                                              GetOrdersOnMySellingOrdersEvents());
                                        });
                                      },
                                      child: _card(
                                        date: state
                            ...
                            is GetOrdersOnMySellingOrdersStatesFailed) {
                          if (state.errType == 0) {
                            // FlashHelper.errorBar(context,
                            //     message: translator.currentLanguage == 'en'
                            //         ? "Please check your network connection."
